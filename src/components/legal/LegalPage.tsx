  ...
  return (
    <>
      ...
      <CTABand
        ...
        title={<>Ready to talk about getting time back?</>}
        description="A 45-minute conversation about your workflows, the work taking too much time, and the tools worth trying first."
